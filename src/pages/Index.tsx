  ...
  const faqItems = [
    {
      ...
      answer: 'Нет! Habit Tracker работает без регистрации. Все ваши данные сохраняются локально в браузере.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Да! После установки PWA приложения, Habit Tracker работает полностью офлайн.',
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50">
      <div className="container mx-auto px-4 py-8">
        <section className="min-h-screen flex items-center justify-center text-center relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 opacity-10 animate-gradient bg-200"></div>
          <div className="relative z-10 animate-fade-in">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <Button
                size="lg"
                className="text-lg px-8 py-6 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 transition-all duration-300 hover:scale-105"
              >
        ...
        <section id="features" className="py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br from-purple-500/10 to-pink-500/10 transition-opacity duration-300 ${
                    isHovered === index ? 'opacity-100' : 'opacity-0'
                  }`}
                ></div>
                <CardHeader className="relative">
                  <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mb-4 transition-transform duration-300 hover:scale-110">
        ...
        <section id="cta" className="py-20">
          <div className="relative overflow-hidden rounded-3xl">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 animate-gradient bg-200"></div>
            <div className="relative z-10 text-center py-20 px-4">
              <h2 className="text-5xl md:text-6xl font-bold text-white mb-6">
                Начните прямо сейчас
              </h2>
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Присоединяйтесь к тысячам людей, которые уже изменили свою жизнь с Habit Tracker
              </p>
              <Button
                size="lg"
        ...
        <footer className="py-12 text-center">
          ...
          <p className="text-sm text-muted-foreground">© 2024 Habit Tracker. Все права защищены.</p>
        </footer>
      </div>
    </div>
  );

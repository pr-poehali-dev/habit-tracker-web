  ...
  const benefits = [
    {
      ...
      description: 'Установите на телефон или ПК как обычное приложение прямо из браузера.',
    ...
    },
    {
      ...
      description: 'Данные обезличены и синхронизируются с сервером. Доступ с любого устройства.',
  ...
  const faqItems = [
    {
      ...
      answer: 'Нет! Habit Track работает без регистрации. Все ваши данные обезличены и синхронизируются через сервер. Просто откройте сайт и начните отслеживать привычки.',
    },
    {
    ...
    },
    {
      ...
      answer: 'PWA (Progressive Web App) — это веб-приложение, которое можно установить как обычное. Вы можете установить Habit Track на главный экран телефона или ПК прямо из браузера.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Да! Данные обезличены и надёжно защищены. Мы синхронизируем только информацию о привычках без личных данных. Ваша конфиденциальность под защитой.',
    },
    {
